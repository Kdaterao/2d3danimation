...
#include "../../../include/Widgets/ToolOptionWidget/ToolViews/BrushWidget/BrushWidget.h"
...
void BrushWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onCellClicked((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (BrushWidget::*)(Brush::RasterTypes )>(_a, &BrushWidget::brushTypeChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (BrushWidget::*)(const QString & , Brush::RasterTypes , int )>(_a, &BrushWidget::brushSelected, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (BrushWidget::*)(bool )>(_a, &BrushWidget::eraserToggled, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (BrushWidget::*)(int )>(_a, &BrushWidget::brushSizeChanged, 3))
            return;
    }
}
...
// SIGNAL 1
void BrushWidget::brushSelected(const QString & _t1, Brush::RasterTypes _t2, int _t3)
{
